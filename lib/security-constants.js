...
export const EMPLOYER_REQUEST_RATE_LIMIT_MAX_REQUESTS = parsePositiveIntEnv(
	'EMPLOYER_REQUEST_RATE_LIMIT_MAX_REQUESTS',
	5
);
export const EMPLOYER_REQUEST_RATE_LIMIT_WINDOW_SECONDS = parsePositiveIntEnv(
	'EMPLOYER_REQUEST_RATE_LIMIT_WINDOW_SECONDS',
	60 * 15
);
export const EMPLOYER_REQUEST_MIN_FORM_FILL_SECONDS = parseNonNegativeIntEnv(
	'EMPLOYER_REQUEST_MIN_FORM_FILL_SECONDS',
	2
);
export const CLIENT_PORTAL_RATE_LIMIT_MAX_REQUESTS = parsePositiveIntEnv(
	'CLIENT_PORTAL_RATE_LIMIT_MAX_REQUESTS',
	60
);
export const CLIENT_PORTAL_RATE_LIMIT_WINDOW_SECONDS = parsePositiveIntEnv(
	'CLIENT_PORTAL_RATE_LIMIT_WINDOW_SECONDS',
	60 * 15
);
export const CLIENT_PORTAL_FEEDBACK_RATE_LIMIT_MAX_REQUESTS = parsePositiveIntEnv(
	'CLIENT_PORTAL_FEEDBACK_RATE_LIMIT_MAX_REQUESTS',
	20
);
export const CLIENT_PORTAL_FEEDBACK_RATE_LIMIT_WINDOW_SECONDS = parsePositiveIntEnv(
